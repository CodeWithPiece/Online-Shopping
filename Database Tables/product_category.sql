...
ALTER TABLE online_shopping.product_category ADD CONSTRAINT `product_category_ibfk_1` FOREIGN KEY (`userId`) 
      REFERENCES `online_shopping.users` (`userId`);
...
ON online_shopping.product_category.userId = online_shopping.users.userId WHERE online_shopping.product_category.userId=3
