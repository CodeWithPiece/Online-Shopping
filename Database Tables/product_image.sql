...
VALUES ("https://images.pexels.com/photos/19361893/pexels-photo-19361893/free-photo-of-aigle.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", 2);
...
ON online_shopping.product_image.productId = online_shopping.product.productId WHERE online_shopping.product_image.productId=2
ORDER BY online_shopping.product_image.imageId DESC;

UPDATE online_shopping.product_image SET imageUrl="https://images.pexels.com/photos", productId=3, updatedAt=CURRENT_TIMESTAMP() WHERE imageId=10;
